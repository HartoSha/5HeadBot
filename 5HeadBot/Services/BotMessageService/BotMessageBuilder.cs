...
namespace _5HeadBot.Services.BotMessageService
{
    public class BotMessageBuilder
    {
        ...
        public BotMessageBuilder WithEmbedDescription(IEnumerable<EmbedFieldBuilder> fields)
        {
            EmbedBuilder.WithFields(fields);
            return this;
        }

        public BotMessageBuilder WithEmbedWithFields(IEnumerable<EmbedFieldBuilder> fields)
        {
            EmbedBuilder.WithFields(fields);
            return this;
        }
